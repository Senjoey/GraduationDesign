...
def multi_test_buy_when_large_derpature(start, end, code_to_test):
    stock_list_to_test = []
    ...
    # print('len(history_prices_list): ', len(history_prices_dict))
    # print('len(history_prices_list[0]): ', len(history_prices_dict['000685']))
    # print('len(history_prices_list[2]): ', len(history_prices_dict['000605']))
    # print('len(history_prices_list[2]): ', len(history_prices_dict['000554']))
    # print('len(history_prices_list[3]): ', len(history_prices_dict['000001']))
    # print('len(close_series_list[0]): ', len(close_series_list[0]['000685']))
    # print('len(open_series_list[0]): ', len(open_series_list[0]['000685']))
    # print('len(ma20_series_round_list[0]): ', len(ma20_series_round_list[0]['000685']))
    # print('len(departure_series_list[0]): ', len(departure_series_list[0]['000685']))
    # print('len(date_index[0]): ', len(date_index))
